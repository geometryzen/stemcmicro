[![npm version](https://badge.fury.io/js/stemcomega.svg)](https://badge.fury.io/js/stemcomega)

STEMComega is a Javascript (Typescript) library for symbolic mathematics.
...
Please take a look at the [tutorial](https://github.com/geometryzen/stemcomega/blob/master/TUTORIAL.md) file.

## Contributing

Please take a look at the [contributing](https://github.com/geometryzen/stemcomega/blob/master/CONTRIBUTING.md) file.

## References

STEMComega is a fork of [Algebrite by Davide Della Casa](https://github.com/davidedc/Algebrite).
