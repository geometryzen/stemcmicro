import { booT, Cell, CellHost, create_flt, create_int, create_str, create_sym, create_tensor, epsilon, Err, et, imu, is_keyword, is_rat, is_str, is_sym, Map, Sym } from "@stemcmicro/atoms";
 ...
 * This is typically used by extensions that provide atoms.
...
/**
 * Used for 2-ary functions where both arguments must be Cons expressions, each with a specified operator.
 */
...
/**
 * Used 1-ary functions so that they can be matched on their operator and argument
 *
 * @param opr The operator for the function.
 * @param arg The hash of the argument.
 */
 ...
 * The hash is intended to match any number of arguments of any type.
 * '(' opr ')'
 */
