...
export function smallToArray(n: number): number[] {
...
export function arrayToSmall(arr: number[]): number | number[] {
...
export function addSmall(a: number[], carry: number): number[] {
...
export function multiplySmall(a: number[], b: number) {
...
export function divMod1(a: number[], b: number[]) {
...
export function divMod2(a: number[], b: number[]) {
