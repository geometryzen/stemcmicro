...
import { Cons3, is_cons, items_to_cons, U } from "@stemcmicro/tree";
...
export abstract class Function3<A extends U, B extends U, C extends U> extends FunctionVarArgs<Cons3<Sym, A, B, C>> {
    constructor(
        name: string,
        opr: Sym,
        private readonly guardA: GUARD<U, A>,
        private readonly guardB: GUARD<U, B>,
        private readonly guardC: GUARD<U, C>
    ) {
        super(name, opr);
    }
