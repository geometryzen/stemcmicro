...
describe("cofactor", function () {
    it("cofactor([[1,2],[3,4]],1,1)", function () {
        const lines: string[] = [`cofactor([[1,2],[3,4]],1,1)`];
    ...
    it("cofactor([[1,2],[3,4]],1,2)", function () {
        const lines: string[] = [`cofactor([[1,2],[3,4]],1,2)`];
        const engine = create_script_context();
        const actual = assert_one_value_execute(lines.join("\n"), engine);
    ...
    it("cofactor([[1,2],[3,4]],2,1)", function () {
        const lines: string[] = [`cofactor([[1,2],[3,4]],2,1)`];
        const engine = create_script_context();
        const actual = assert_one_value_execute(lines.join("\n"), engine);
    ...
    it("cofactor([[1,2],[3,4]],2,2)", function () {
        const lines: string[] = [`cofactor([[1,2],[3,4]],2,2)`];
        const engine = create_script_context();
        const actual = assert_one_value_execute(lines.join("\n"), engine);
