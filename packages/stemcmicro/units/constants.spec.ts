...
const pi_svg_sym = [`<svg height='36'width='32'>`, `<text style='font-family:"Times New Roman";font-size:24px;font-style:italic;'x='10'y='26'>&pi;</text>`, `</svg>`].join("");
...
describe("pi in Eigenmath", function () {
    it("is recognized as being the mathematical symbol", function () {
        const lines: string[] = [`pi=tau(1/2)`, `pi`, `float(pi)`];
