...
describe("gibbs", function () {
    it("Scalar or Dot Product", function () {
        const lines: string[] = [`G30=algebra([1,1,1],["e1","e2","e3"])`, `e1=G30[1]`, `e2=G30[2]`, `e3=G30[3]`, `A = Ax * e1 + Ay * e2 + Az * e3`, `B = Bx * e1 + By * e2 + Bz * e3`, `A|B`];
    ...
    it("Vector or Cross Product", function () {
        const lines: string[] = [`G30=algebra([1,1,1],["e1","e2","e3"])`, `e1=G30[1]`, `e2=G30[2]`, `e3=G30[3]`, `A = Ax * e1 + Ay * e2 + Az * e3`, `B = Bx * e1 + By * e2 + Bz * e3`, `cross(A,B)`];
        const engine = create_script_context({
            dependencies: ["Blade", "Vector", "Flt", "Imu", "Uom"]
        });
        const value = assert_one_value_execute(lines.join("\n"), engine);
    ...
    it("Magnitude of a Vector", function () {
        const lines: string[] = [`G30=algebra([1,1,1],["e1","e2","e3"])`, `e1=G30[1]`, `e2=G30[2]`, `e3=G30[3]`, `A = Ax * e1 + Ay * e2 + Az * e3`, `abs(A)`];
        const engine = create_script_context({
            dependencies: ["Blade", "Vector", "Flt", "Imu", "Uom"],
            disable: [Directive.factoring]
        });
    ...
    it("Show how to find A, given u=A+B and v=A-B", function () {
        const lines: string[] = [`G30=algebra([1,1,1],["e1","e2","e3"])`, `e1=G30[1]`, `e2=G30[2]`, `e3=G30[3]`, `A = Ax * e1 + Ay * e2 + Az * e3`, `B = Bx * e1 + By * e2 + Bz * e3`, `u=A+B`, `v=A-B`, `(u+v)/2`];
        const engine = create_script_context({
            dependencies: ["Blade", "Vector", "Flt", "Imu", "Uom"]
        });
        const value = assert_one_value_execute(lines.join("\n"), engine);
    ...
    it("A vector equation can be reduced to the form A = B. Show that this is equal to three scalar equations", function () {
        ...
        const lines: string[] = [`G30=algebra([1,1,1],["e1","e2","e3"])`, `e1=G30[1]`, `e2=G30[2]`, `e3=G30[3]`, `A = Ax * e1 + Ay * e2 + Az * e3`, `B = Bx * e1 + By * e2 + Bz * e3`, `A|e1-B|e1`];
        const engine = create_script_context({
            dependencies: ["Blade", "Vector", "Flt", "Imu", "Uom"]
        });
        const value = assert_one_value_execute(lines.join("\n"), engine);
    ...
    it("A*A should be equal to A|A (Geometric Algebra)", function () {
        const lines: string[] = [`G30=algebra([1,1,1],["e1","e2","e3"])`, `e1=G30[1]`, `e2=G30[2]`, `e3=G30[3]`, `A = Ax * e1 + Ay * e2 + Az * e3`, `A*A`];
        const engine = create_script_context({
            dependencies: ["Blade", "Vector", "Flt", "Imu", "Uom"],
            disable: [Directive.factoring]
        });
