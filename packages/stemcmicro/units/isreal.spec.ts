...
describe("isreal", function () {
    it("isreal(i^(4/1)", function () {
        const lines: string[] = [`i=sqrt(-1)`, `isreal(i**(4/1))`];
    ...
    it("isreal(i^(3/2)", function () {
        const lines: string[] = [`i=sqrt(-1)`, `isreal(i**(3/2))`];
        const sourceText = lines.join("\n");
    ...
    it("isreal(i**(4/3)", function () {
        const lines: string[] = [`i=sqrt(-1)`, `isreal(i**(4/3))`];
        const sourceText = lines.join("\n");
    ...
    it("isreal(x^(3/2)", function () {
        const lines: string[] = [`isreal(x**(3/2))`];
        const sourceText = lines.join("\n");
    ...
    it("re(i*z) when z is not real", function () {
        const lines: string[] = [`i=sqrt(-1)`, `re(i*z)`];
        const engine = create_script_context({
            assumes: {
                z: { real: false }
            },
    ...
    it("isreal(i).", function () {
        const lines: string[] = [`i=sqrt(-1)`, `isreal(i)`];
        const engine = create_script_context({
            assumes: {
                a: { real: false }
            }
    ...
    it("isreal(i*y).", function () {
        const lines: string[] = [`i=sqrt(-1)`, `isreal(i*y)`];
        const engine = create_script_context({
            assumes: {
                y: { real: true }
            }
    ...
    it("isreal(exp(a))", function () {
        const lines: string[] = [`autofactor=0`, `i=sqrt(-1)`, `pi=tau(1)/2`, `isreal(exp(a))`];
        const sourceText = lines.join("\n");
    ...
    it("isreal(3^(1/2))", function () {
        const lines: string[] = [`autofactor=0`, `i=sqrt(-1)`, `pi=tau(1)/2`, `isreal(3^(1/2))`];
        const sourceText = lines.join("\n");
