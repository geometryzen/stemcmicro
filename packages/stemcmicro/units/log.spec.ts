...
describe("log", function () {
    ...
    it("log(clock(i))", function () {
        const lines: string[] = [`i=sqrt(-1)`, `log(clock(i))`];
        const engine = create_script_context({
