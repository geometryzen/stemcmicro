...
describe("sin", function () {
    it("sin(a)*cos(b)+cos(a)*sin(b)-sin(a+b) without factoring", function () {
        const lines: string[] = [`sin(a)*cos(b)+cos(a)*sin(b)-sin(a+b)`];
...
describe("sin", function () {
    ...
    it("sin(b)*cos(a)-cos(b)*sin(a)", function () {
        ...
        const lines: string[] = [`sin(b)*cos(a)-cos(b)*sin(a)`];
        const engine = create_script_context({
            dependencies: []
        });
        const value = assert_one_value_execute(lines.join("\n"), engine);
    ...
    it("sin(a+b)-(sin(a)*cos(b)+cos(a)*sin(b))", function () {
        const lines: string[] = [`sin(a+b)-(sin(a)*cos(b)+cos(a)*sin(b))`];
        const engine = create_script_context({
            enable: [Directive.expandSinSum],
            dependencies: []
        });
    ...
    it("cos(b)*sin(a)+cos(a)*sin(b)-sin(a+b)", function () {
        const lines: string[] = [`cos(b)*sin(a)+cos(a)*sin(b)-sin(a+b)`];
        const engine = create_script_context({
            enable: [Directive.expandSinSum],
            dependencies: []
        });
    ...
    it("sin", function () {
        const lines: string[] = [`pi=tau(1)/2`, `f(a,x)=1+sin(float(a/360*2*pi))-float(x)+sin(a/360*2*pi)-x`, `f(270,-1)`];
