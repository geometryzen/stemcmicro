...
describe("tensor", function () {
    ...
    it("parsing", function () {
        const lines: string[] = [`A=((a,b),(c,d))`, `A`];
        const sourceText = lines.join("\n");
    ...
    describe("index", function () {
        ...
        it("A[1]", function () {
            const lines: string[] = [`A=[[a,b],[c,d]]`, `A[1]`];
            const sourceText = lines.join("\n");
            const engine = create_script_context();
            const actual = assert_one_value_execute(sourceText, engine);
        ...
        it("A[2]", function () {
            const lines: string[] = [`A=[[a,b],[c,d]]`, `A[2]`];
            const sourceText = lines.join("\n");
            const engine = create_script_context();
            const actual = assert_one_value_execute(sourceText, engine);
        ...
        it("A[1,1]", function () {
            const lines: string[] = [`A=[[a,b],[c,d]]`, `A[1,1]`];
            const sourceText = lines.join("\n");
            const engine = create_script_context();
            const actual = assert_one_value_execute(sourceText, engine);
        ...
        it("A[1,2]", function () {
            const lines: string[] = [`A=[[a,b],[c,d]]`, `A[1,2]`];
            const sourceText = lines.join("\n");
            const engine = create_script_context();
            const actual = assert_one_value_execute(sourceText, engine);
        ...
        it("A[2,1]", function () {
            const lines: string[] = [`A=[[a,b],[c,d]]`, `A[2,1]`];
            const sourceText = lines.join("\n");
            const engine = create_script_context();
            const actual = assert_one_value_execute(sourceText, engine);
        ...
        it("A[2,2]", function () {
            const lines: string[] = [`A=[[a,b],[c,d]]`, `A[2,2]`];
            const sourceText = lines.join("\n");
            const engine = create_script_context();
            const actual = assert_one_value_execute(sourceText, engine);
    ...
    describe("algebra", function () {
        it("[[a,b],[c,d]]+[[p,q],[r,s]]", function () {
            const lines: string[] = [`[[a,b],[c,d]]+[[p,q],[r,s]]`];
            const engine = create_script_context({
                dependencies: [],
        ...
        it("[[p,q],[r,s]]+[[a,b],[c,d]]", function () {
            const lines: string[] = [`[[p,q],[r,s]]+[[a,b],[c,d]]`];
            const engine = create_script_context({
                dependencies: [],
                useCaretForExponentiation: false
            });
    ...
    it("inv-adj/det", function () {
        const lines: string[] = [`A=[[a,b],[c,d]]`, `inv(A)-adj(A)/det(A)`];
        const sourceText = lines.join("\n");
        const engine = create_script_context();
        const actual = assert_one_value_execute(sourceText, engine);
    ...
    it("inv", function () {
        const lines: string[] = [`A=[[1,-0.1],[0.2,-1]]`, `inv(A)`];
        const sourceText = lines.join("\n");
        const engine = create_script_context();
        const actual = assert_one_value_execute(sourceText, engine);
