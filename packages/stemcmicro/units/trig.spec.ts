...
describe("trig", function () {
    xit("cos(x)*cos(x)+sin(x)*sin(x)", function () {
        const lines: string[] = [`cos(x)*cos(x)+sin(x)*sin(x)`];
...
describe("trig", function () {
    describe("function ordering of trig functions in factors", function () {
        ...
        it("sin(a)*cos(b)", function () {
            const lines: string[] = [`sin(a)*cos(b)`];
            const engine = create_script_context({
                dependencies: []
            });
            const value = assert_one_value_execute(lines.join("\n"), engine);
        ...
        it("cos(b)*sin(a)", function () {
            const lines: string[] = [`cos(b)*sin(a)`];
            const engine = create_script_context({
                dependencies: []
            });
            const value = assert_one_value_execute(lines.join("\n"), engine);
        ...
        it("sin(b)*cos(a)", function () {
            const lines: string[] = [`sin(b)*cos(a)`];
            const engine = create_script_context({
                dependencies: []
            });
            const value = assert_one_value_execute(lines.join("\n"), engine);
        ...
        it("cos(a)*sin(b)", function () {
            const lines: string[] = [`cos(a)*sin(b)`];
            const engine = create_script_context({
                dependencies: []
            });
            const value = assert_one_value_execute(lines.join("\n"), engine);
        ...
        it("sin(x)*cos(x)", function () {
            ...
            const lines: string[] = [`sin(x)*cos(x)`];
            const engine = create_script_context({
                dependencies: []
            });
            const value = assert_one_value_execute(lines.join("\n"), engine);
        ...
        it("cos(x)*sin(x)", function () {
            const lines: string[] = [`cos(x)*sin(x)`];
            const engine = create_script_context({
                dependencies: []
            });
            const value = assert_one_value_execute(lines.join("\n"), engine);
    ...
    describe("trig", function () {
        ...
        xit("sin(x)*sin(x)+cos(x)*cos(x)", function () {
            const lines: string[] = [`sin(x)*sin(x)+cos(x)*cos(x)`];
            const engine = create_script_context({
                dependencies: []
            });
            const value = assert_one_value_execute(lines.join("\n"), engine);
