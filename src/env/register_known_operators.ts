...
import { add_2_mul_2_cos_sin_mul_2_mul_2_rat_cos_sin } from '../operators/trig/add_2_mul_2_cos_sin_mul_2_mul_2_rat_cos_sin';
...
import { add_2_mul_2_cos_sin_mul_2_cos_sin } from '../operators/trig/add_2_mu_2_cos_sin_mul_2_cos_sin';
...
export function register_known_operators(version: 1 | 2 | 3, options: SymEngineOptions | undefined, $: ExtensionEnv) {
    ...
    $.defineOperator(add_2_mul_2_cos_sin_mul_2_cos_sin);
    ...
    $.defineOperator(add_2_mul_2_cos_sin_mul_2_mul_2_rat_cos_sin);
