...
import { Cons2, items_to_cons, nil, U } from "math-expression-tree";
import { EnvConfig } from "../../env/EnvConfig";
import { diffFlag, ExtensionEnv, make_extension_builder, TFLAGS, TFLAG_DIFF, TFLAG_NONE } from "../../env/ExtensionEnv";
...
export const assign_sym_any = make_extension_builder<EXP>(Op);
