...
export function render_using_print_mode(expr: U, printMode: PrintMode, $: PrintConfig): string {
    switch (printMode) {
        case PrintMode.Ascii: return render_as_ascii(expr, $);
        case PrintMode.Human: return render_as_human(expr, $);
        case PrintMode.Infix: return render_as_infix(expr, $);
        case PrintMode.LaTeX: return render_as_latex(expr, $);
        case PrintMode.SExpr: return render_as_sexpr(expr, $);
