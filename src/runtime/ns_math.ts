...
export const MATH_E = native_sym(Native.mathematical_constant_Eulers_number_Napiers_constant);
export const MATH_PI = native_sym(Native.mathematical_constant_Pi);
