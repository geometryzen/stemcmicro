...
/**
 * This would be called an Identifier in TypeScript.
 */
...
export const AsteriskToken = next_code('*');
/**
 * '/'
 */
 ...
 * '^'
 */
export const CaretToken = next_code('^');
/**
 * '|'
 */
export const T_VBAR = next_code('|');
/**
 * The token signifying the End Of Source Text.
 */
